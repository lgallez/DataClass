...
def welcome():
    return (
        ...
        f"<br/>"
        f"/api/v1.0/start<br/>"
        f"With the start date (YYYY-MM-DD), calculates summary stat temperature for all dates greater than and equal to the start date<br/>"
        f"<br/>"
        f"/api/v1.0/start/end<br/>"
        f"With the start and end date (YYYY-MM-DD), calculate the summary stat temperature for dates between the start and end date inclusive<br/>"
    )
